...
from main.models import AdditionalImage, AdvUser, Bb, Comment, SubRubric, SuperRubric
...
class ProfileEditForm(forms.ModelForm):
    ...
    class Meta:
        model = AdvUser
        fields = ("username", "email", "first_name", "last_login", "send_messages")
...
class RegisterForm(forms.ModelForm):
    ...
    password2 = forms.CharField(
        ...
        help_text="Введите тот же самый пароль еще раз для провеки",
    )
